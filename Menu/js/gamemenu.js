		...
		mainMenu:{
			...
			loadGame:{
				...
				subMenu:{
					options:{
						opt0: {
							title: "Um jogo de Puzzle, desenvolvido para ajudar na capacidade de raciocínio lógico do jogador, use o botão esquerdo do seu mouse para mover as peças.",
							callback:function(){
								showLoading();
							}
